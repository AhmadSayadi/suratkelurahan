...
<body>  <div align="center" id="leftPango1"><span class="title">FORM PANGKAT</span></div>
<form id="form1" name="form1" method="post" action="script/simpanpangkat.php">         
 <table width="100%" border="0" cellpadding="2" cellspacing="2">

            <tr>
              <td><table align="left" border="0" cellpadding="0" cellspacing="5">
			  <tbody>
			  <tr><td colspan="4"><br/><h2>Form Pangkat</h2></td></tr>
			   <tr>
                    <td width="5%"><div align="center">1</div></td>
                    <td width="30%"><div align="left">Nama Pangkat</div></td>

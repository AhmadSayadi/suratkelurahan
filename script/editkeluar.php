...
$stock2=mysql_fetch_array(mysql_query("SELECT jumlah_keluar FROM obat_keluar WHERE no = '$no' ")); 
$harga2=$stock2[0];
...
$perintah = "update obat_keluar set id_obat='$id',nama_obat='$nama',jumlah_keluar='$jumlah',tgl_keluar='$tgl' where no=$no";
				$hasil = mysql_query($perintah);
				if ($hasil) {
				?><script language="JavaScript">alert('Data Disimpan');
				document.location='keluar.php'</script><?
				}else {
...
<body>
  ...
  <div id="wrapper">
        ...
        <div id="tombol">
		<div class="tombol">
		<la><a href='keluar.php'>HOME</a></la>
		</div>
		</div>
		<div id="tombol">
		<div class="tombol">
		<la><a href='carikeluar.php'>CARI DATA</a></la>
		</div>
		</div>
		<div id="tombol">
		<div class="tombol">
		<la><a href='cetakkeluar.php'>CETAK DATA</a></la>
		</div>
		</div>
		<div id="tombol">
		<div class="tombol">
            ...
            <tr>
			  ...
			  <tr>
				...
				<tr valign="top">
                    ...
                    <td><div align="left">Jumlah Keluar</div></td>
                    <td><div align="center">:</div></td>
                    <td><div align="left"><input name="jumlah" size="25" type="text" id="jumlah" value="<?=$row["jumlah_keluar"] ?>" /></div>
                    </td>
				  </tr>
				  <tr valign="top">
                    ...
                    <td><div align="center">:</div></td>
                    <td><div align="left"><input name="tgl" size="25" type="text" id="tgl" value="<?=$row["tgl_keluar"] ?>" />Mis. 2012-08-20</div>
                    </td>
				  </tr>
				<tr>

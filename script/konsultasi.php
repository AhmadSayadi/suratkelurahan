...
<div align="center" id="leftPango1"><span class="title">FORM KONSULTASI</span></div>
<br/>
<h2>Form Konsultasi</h2>
<center>
<form name="form" action="script/simpankonsultasi.php" method="post" onSubmit="return check()">		
<table width="450" border="0" class="tabel">
  ...
  <tr>
    <td width="130">&nbsp;<span class="tulis">KONSULTASI</span></td>

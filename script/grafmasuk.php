...
$query = "SELECT sum(jumlah_masuk) AS jumlah, monthname(tgl_masuk) as tahun FROM obat_masuk where year(tgl_masuk)='$tahun' group by month(tgl_masuk)";
...
$graph->title->Set("Grafik Jumlah Obat Masuk");

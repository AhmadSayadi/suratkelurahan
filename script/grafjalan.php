...
$query = "SELECT count(*) AS jumlah, monthname(tgl_periksa) as tahun FROM rawat_jalan where year(tgl_periksa)='$tahun' and status='$status' group by month(tgl_periksa)";
...
$graph->title->Set("Grafik Jumlah Pasien " .$status);

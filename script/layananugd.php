...
<script type="text/javascript">
 ...
 <div align="center" id="leftPango1"><span class="title">POLI UNIT GAWAT DARURAT</span></div>
<br/><div>
 <h2>Data Pasien</h2>
 		 	<?php
			include "koneksi.php";
...
?></div>
	...
	<div align="center" id="leftPango1"><span class="title">Form Kunjungan Unit Gawat Darurat</span></div>
<br/><div>
	<h2>Form Kunjungan Unit Gawat Darurat</h2><br>
		<form id="form1" name="form1" method="post" onSubmit="return validasi(this)" action="script/simpanantrianugd.php?norekammedik=<?php echo $row['norekammedik']?>">         
			  ...
			  <tbody>
			    ...
			    <tr>
                 ...
                 <tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"><input name="poli" readonly="true" id="poli" size="25" value="UGD"/></div>
					</td>
				</tr>

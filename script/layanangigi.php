...
<script type="text/javascript">
 ...
 <div align="center" id="leftPango1"><span class="title">POLI GIGI</span></div>
...
?></div>
	...
	<div align="center" id="leftPango1"><span class="title">Form Kunjungan Poli Gigi</span></div>
<div><br/>
	<h2>Form Kunjungan Poli Gigi</h2><br>
		<form id="form1" name="form1" method="post" onSubmit="return validasi(this)" action="script/simpanantriangigi.php?norekammedik=<?php echo $row['norekammedik']?>">         
                 ...
                 <tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"> <select name="nip" required>
						...
						<?php
						include "koneksi.php";
						$tampil = mysql_query("select * from dokter where poli='Gigi'");
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"><input name="poli" readonly="true" id="poli" size="25" value="Gigi"/></div>
					</td>
				</tr>

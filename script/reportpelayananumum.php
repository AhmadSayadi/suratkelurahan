...
echo $str;
 ...
 <table width="100%" border="0" cellpadding="2" cellspacing="2">
	...
	Keterangan Sakit :<br/>
	<p align="justify"><?php 
	$mintasd="select * from antrian where idantrian = '$_GET[idantrian]' ";
				$ll =mysql_fetch_array(mysql_query($mintasd));
	
	echo $ll['keterangan']?></p></td>
			</tr>
 ...
 print "<tr align=\"center\"align=\"middle\">
	...
	<td align='right'>$baris[bayar]</td>
		...
		<td align="right"><?php
		$jj="select sum(bayar) from pelayanan where idantrian = '$_GET[idantrian]' ";
										$kk =mysql_fetch_array(mysql_query($jj));
		echo $kk[0];
		?></td>
		</tr>
				</table>

...
<br/>
 <div align="center" ><h2>GRAFIK PENGUNJUNG</h2></div>
				...
				<tr>
					...
					$tgl_temp=explode("-",$row['namasetting']); 
						...
						$thn=$tgl_temp[0]; 		
							...
							?></font></div></th>
					<td align="center"><?php 
					$queryw=mysql_fetch_array(mysql_query("select count(idantrian) from antrian where tanggalkunjungan='$row[namasetting]' and poli='KIA'"));
					echo $queryw[0];
					?></font></td>

...
<title>Data Pelayanan Gizi</title>
...
$sqllll = " Select *
		from rujukan
		where idrujukan='$_GET[idrujukan]'";
$resultlll = mysql_query($sqllll) or die(mysql_error());
$rowlll = mysql_fetch_array($resultlll);
				?><tr>

			<td colspan="6">
	Diagnosa Awal :<br/>
	<p align="justify"><?php echo $rowlll['diagnosaawal']?></p></td>
			</tr><tr>

			<td colspan="6">
	Diagnosa Akhir :<br/>
	<p align="justify"><?php echo $rowlll['diagnosaakhir']?></p></td>
			</tr>
				...
				<?php
				$minta="select * from pelayanan where idantrian = '$_GET[idantrian]' && poli ='Gigi'";
				$eksekusi =mysql_query($minta);
		
				if(mysql_num_rows($eksekusi) != 0){
				?>
				<br/>
				<h2>Daftar Pelayanan Poli Gizi</h2><br/>
 ...
 print "<tr align=\"center\"align=\"middle\">
	...
	<td>$baris[bayar]</td>
		...
		?>
				...
				<table class="data" border="1" cellpadding="0" cellspacing="0">
				<?
				$jum="SELECT SUM(bayar) as jum FROM pelayanan where idantrian = '$_GET[idantrian]' && poli ='Gigi'";
				$eks = mysql_query($jum);
				...
				<?php
				$minta="select * from pelayanan where idantrian = '$_GET[idantrian]' && poli ='MTBS'";
				$eksekusi =mysql_query($minta);
		
				if(mysql_num_rows($eksekusi) != 0){
				?>
				<br/>
				<h2>Daftar Pelayanan Poli MTBS</h2><br/>
		<table class="data" border="1" cellpadding="0" cellspacing="0">
		<tr align='center'>
		  <th width="3%">No</th>
		  <th width="10%">Tanggal</th>
 ...
 print "<tr align=\"center\"align=\"middle\">
	...
	<td>$baris[rujukanke]</td>
		...
		?>
				...
				if(mysql_num_rows($eksekusi) != 0){
				?>
				<br/><h2>Daftar Rujukan Rumah Sakit</h2><br/>
		<table class="data" border="1" cellpadding="0" cellspacing="0">
		<tr align='center'>
		  <th width="3%">No</th>
		  <th width="10%">Tanggal</th>

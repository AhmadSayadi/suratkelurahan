...
<title>Data Pelayanan Umum</title>
...
$rowl = mysql_fetch_array($resultl);
			...
			<td colspan="6">
	Keterangan Sakit :<br/>
	<p align="justify"><?php echo $rowl['keterangan']?></p></td>
			</tr>
				...
				<?php
				$minta="select * from pelayanan where idantrian = '$_GET[idantrian]' && jenispelayanan ='ANC/PNC'";
				$eksekusi =mysql_query($minta);
		
				if(mysql_num_rows($eksekusi) != 0){
				?>
				<br/>
				<h2>Daftar Pelayanan ANC/PNC</h2><br/>
		<table class="data" border="1" cellpadding="0" cellspacing="0">
		<tr align='center'>
		  <th width="3%">No</th>
		  <th width="10%">Tanggal</th>
		  <th width="10%">Keterangan</th>
		  <th width="8%">Jenis Pelayanan</th>
		 </tr>
		<?
 ...
 print "<tr align=\"center\"align=\"middle\">
	...
	<td>$baris[rujukanke]</td>
		...
		?>
				...
				<?php
				$minta="select * from rujukan where idantrian = '$_GET[idantrian]' && rujukanke ='Gizi'";
				$eksekusi =mysql_query($minta);
		
				if(mysql_num_rows($eksekusi) != 0){
				?>
				<br/>
				<h2>Daftar Rujukan Poli Gizi</h2><br/>
		<table class="data" border="1" cellpadding="0" cellspacing="0">
		<tr align='center'>
		  <th width="3%">No</th>
		  <th width="10%">Tanggal</th>

...
$row = mysql_fetch_array($result);
	?>
	<center>
 <div align="center" id="leftPango1"><span class="title">EDIT PELAYANAN ANC/PNC</span></div>
</center>
 <br/>
                  <h2>Edit Pelayanan ANC/PNC</h2>
	
				<form id="form1" name="form1" method="post" action="script/updatepelayananbalitasakitkia.php?idpelayanan=<?php echo $_GET['idpelayanan'];?>&idantrian=<?php echo $row['idantrian']?>">         

...
<form id="form1" name="form1" method="post" action="script/updatepelayananlab.php?idantrian=<?php echo $row['idantrian'];?>">         
 <table width="100%" border="0" cellpadding="2" cellspacing="2">
            ...
            <tr>
			  ...
			  <tbody>
			  <tr><td colspan="4"><br/><h2>Pelayanan Lab</h2></td></tr>
		...
		<tr><td colspan="4" align="left"><a target="_BLANK" href="script/rekammedikrujukanpolilab.php?idantrian=<?php echo $row['idantrian']?>&norekammedik=<?php echo $row['norekammedik']?>"><img src="images/report.png" width="35">Report Pelayanan</a></td>
           </tr>                 
				...
				</form><?php include "formpelayananlab.php";?><br/>
				<?php include "daftarpelayananlaboratorium.php";?>

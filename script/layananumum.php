...
<div align="center" id="leftPango1"><span class="title">POLI UMUM</span></div>
...
?></div>
	...
	<div align="center" id="leftPango1"><span class="title">Form Kunjungan Poli Umum</span></div>
<div><br/>
	<h2>Form Kunjungan Poli Umum</h2>
		<form id="form1" name="form1" onSubmit="return validasi(this)" method="post" action="script/simpanantrianumum.php?norekammedik=<?php echo $row['norekammedik']?>">         
            ...
            <tr>
			  ...
			  <tbody>
                ...
                <tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"><input readonly="true" value="0"name="keterangan" id="keterangan" size="25" value="<? echo $row["biaya"] ?>"/></div>
					</td>
				</tr><tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"> <select name="nip" required>
						...
						<?php
						include "koneksi.php";
						$tampil = mysql_query("select * from dokter where poli='Umum'");
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"><input name="poli" readonly="true" id="poli" size="25" value="Umum"/></div>
					</td>
				</tr>

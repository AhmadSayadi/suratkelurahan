...
<body>  <div align="center" id="leftPango1"><span class="title">PELAYANAN GIZI</span></div>
<?
include "koneksi.php";
$id = $_GET['idantrian'];
...
?>	
 <table width="100%" border="0" cellpadding="2" cellspacing="2">
            ...
            <tr>
			  ...
			  <tbody>
			  <tr><td colspan="4"><br/><h2>Pelayanan Gizi</h2></td></tr>
			...
			$tgl_temp1=explode("-",$row['tanggalkunjungan']); 
				...
				<?php include "formpelayanangizi.php";?><br/>
				<?php include "menurujukangizi.php";?><br/>

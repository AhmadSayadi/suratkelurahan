...
<html>
	...
	<body>
 <div align="center" id="leftPango1"><span class="title">GRAFIK PENGUNJUNG POLI GIZI</span></div>
	<br/><div align="center" ><h2>Grafik Pengunjung Poli Gizi</h2></div>
				...
				<tr>
					...
					$tgl_temp=explode("-",$row['namasetting']); 
						...
						$thn=$tgl_temp[0]; 		
							...
							?></font></div></th>
					<td align="center"><?php 
					$queryw=mysql_fetch_array(mysql_query("select count(idrujukan) from rujukan where tgl_rujukan='$row[namasetting]' && rujukanke='Gizi'"));
					echo $queryw[0];
					?></font></td>

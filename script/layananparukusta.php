...
<script type="text/javascript">
 ...
 <div align="center" id="leftPango1"><span class="title">POLI PARU & KUSTA</span></div>
...
?></div>
	...
	<div align="center" id="leftPango1"><span class="title">Form Kunjungan Poli Paru & Kusta</span></div>
<div><br/>
	<h2>Form Kunjungan Poli Paru & Kusta</h2><br>
		<form id="form1" name="form1" method="post" onSubmit="return validasi(this)" action="script/simpanantrianparukusta.php?norekammedik=<?php echo $row['norekammedik']?>">         
			  ...
			  <tbody>
			    ...
			    <tr>
                 ...
                 <tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"><input name="poli" readonly="true" id="poli" size="25" value="Paru & Kusta"/></div>
					</td>
				</tr>

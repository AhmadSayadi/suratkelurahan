...
<div id="templatemo_wrapper">
	...
	<div id="tempaltemo_header">
    	...
    	<div id="header_content">
        	<div id="site_title">
				<img src="images/templatemo_logo.png" alt="LOGO" width="645" height="99" /> </div>
      </div>
    </div> <!-- end of header -->
...
<!-- End css3menu.com BODY section -->    	
  	...
  	<li><a href="?kelurahan=administrator" target="_parent">Buku Tamu</a></li>
  	<li><a href="?kelurahan=pengaduan" target="_parent">Pengaduan</a></li>
  	<li><a href="?kelurahan=daftarberita" target="_parent">Daftar Berita</a></li>
  	<li><a href="?kelurahan=tambahgaleri" target="_parent">Daftar Galeri</a></li>
	<li><a href="?kelurahan=akunwebsite" target="_parent">Akun</a></li>
		           </ul>    	

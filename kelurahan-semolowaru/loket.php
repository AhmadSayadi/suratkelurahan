...
<!-- End css3menu.com BODY section -->    	
  	...
  	<li><a href="?kelurahan=pasienbaru" target="_parent">Pasien Baru</a></li>
  	<li><a href="?kelurahan=pasien" target="_parent">Pasien Lama</a></li>
  	<li><a href="?kelurahan=antrian" target="_parent">Antrian</a></li>
  	<li><a href="?kelurahan=cetaklaporanloket" target="_parent">Cetak Laporan</a></li>
  	<li><a href="?kelurahan=grafikpengunjung" target="_parent">Grafik</a></li>
  	<li><a href="?kelurahan=akunloket" target="_parent">Akun</a></li>
		           </ul>    	

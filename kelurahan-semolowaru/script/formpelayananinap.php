...
<body>  <div align="center" id="leftPango1"><span class="title">FORM PELAYANAN RAWAT INAP</span></div>
<form id="form1" name="form1" method="post" action="script/simpanpelayananinap.php?idantrian=<?php echo $_GET['idantrian']?>&norekammedik=<?php echo $row1['norekammedik'];?>">         
 <table width="100%" border="0" cellpadding="2" cellspacing="2">

            <tr>
              <td><table align="left" border="0" cellpadding="0" cellspacing="5">
			  <tbody>
			  <tr><td colspan="4"><br/><h2>Form Pelayanan Rawat Inap</h2></td></tr>
			   <tr>
					...
					<select onchange="getData(this.value)" name="namasetting" required>
						...
						<?php
						include "koneksi.php";
						$tampil = mysql_query("select * from setting where jenissetting='Bayar'");

...
$row = mysql_fetch_array($result);
	?>
	<center>
 <div align="center" id="leftPango1"><span class="title">EDIT PELAYANAN TINDIK</span></div>
</center>
 <br/>
                  <h2>Edit Pelayanan Tindik</h2>
	
				<form id="form1" name="form1" method="post" action="script/updatepelayanantindikkia.php?idpelayanan=<?php echo $_GET['idpelayanan'];?>&idantrian=<?php echo $row['idantrian']?>">         

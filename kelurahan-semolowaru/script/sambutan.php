		 ...
		 <div id="rightcolumn">
		 <div align="center" id="leftPango1"><span class="title">SAMBUTAN KEPALA KELURAHAN SEMOLOWARU</span></div>
<br/>
...
<table style="text-align:justify;width:100%; background-color:#f0f0f0; border:1px solid #000099; padding:8px;" width="100%" border="0" cellspacing="1" cellpadding="2">
 ...
 <tr>
    ...
    <td width="450" align="center" ><a href="images/monitor_icon.png" class="pirobox"><p align="justify" ><img  style="float:left; margin:0 8px 4px 0;" width="125" height="150" src="images/monitor_icon.png"></a><? echo $row[2];?></p></td>
  </tr>

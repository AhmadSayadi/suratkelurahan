...
$row = mysql_fetch_array($result);
	?>
	<center>
 <div align="center" id="leftPango1"><span class="title">EDIT RUJUKAN UGD GIZI</span></div>
</center>
 <br/>
                  <h2>Edit Rujukan UGD Gizi</h2>
	
				<form id="form1" name="form1" method="post" action="script/updaterujukanugdgizi.php?idantrian=<?php echo $_GET['idantrian'];?>&idrujukan=<?php echo $_GET['idrujukan']?>">         

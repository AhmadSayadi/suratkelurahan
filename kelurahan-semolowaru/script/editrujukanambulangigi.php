...
$row = mysql_fetch_array($result);
	?>
	<center>
 <div align="center" id="leftPango1"><span class="title">EDIT RUJUKAN AMBULAN GIGI</span></div>
</center>
 <br/>
                  <h2>Edit Rujukan Ambulan Gigi</h2>
	
				<form id="form1" name="form1" method="post" action="script/updaterujukanambulangigi.php?idantrian=<?php echo $_GET['idantrian'];?>&idrujukan=<?php echo $_GET['idrujukan']?>">         
...
?>
			  <tr>
				...
				<tr>
                    <td width="5%"><div align="center">2</div></td>
                    <td width="30%"><div align="left">Alamat Tujuan</div></td>
                    <td width="5%"><div align="center">:</div></td>

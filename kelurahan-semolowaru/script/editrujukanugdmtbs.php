...
$row = mysql_fetch_array($result);
	?>
	<center>
 <div align="center" id="leftPango1"><span class="title">EDIT RUJUKAN UGD MTBS</span></div>
</center>
 <br/>
                  <h2>Edit Rujukan UGD MTBS</h2>
	
				<form id="form1" name="form1" method="post" action="script/updaterujukanugdmtbs.php?idantrian=<?php echo $_GET['idantrian'];?>&idrujukan=<?php echo $_GET['idrujukan']?>">         

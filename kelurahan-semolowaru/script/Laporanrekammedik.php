...
<title>Rekam Medik Pasien</title>
...
echo $str;
 ...
 <table width="100%" border="0" cellpadding="2" cellspacing="2">
		...
		<?
		  								...
		  								$minta="select * from antrian where norekammedik='$_GET[norekammedik]'";
 ...
 $eksekusids = mysql_fetch_array(mysql_query($mintads));
					...
					$tgl_temp=explode("-",$baris['tanggalkunjungan']); 
						$tgl=$tgl_temp[2];
						$bln=$bulan_long[$tgl_temp[1]-1]; 
						$thn=$tgl_temp[0]; 		
							
	$mintad="select * from pelayanan where norekammedik = '$_GET[norekammedik]'";
...
?>
<tr valign="top" align=\"left\"align=\"middle\">
	<td><?php echo $no;?></td>
	<td><?php echo $tgl; echo " "; echo $bln; echo " "; echo $thn;?></td>
	<td><?php 
	
		  								$gg="select * from pelayanan where idantrian='$baris[idantrian]'";
										$bb =mysql_query($gg);
										echo "<b>Loket :</b>";
										...
										$dfg="select * from setting where idsetting = '$ff[keterangan]'";
										...
										$gg="select * from pelayanan where idantrian='$baris[idantrian]'";
										$bb =mysql_query($gg);
										echo "<br/><b>Apotik :</b><br/>";
										while($ff=mysql_fetch_array($bb)){						
										if($ff['poli']=='Apotik'){
										
										$dfg="select * from obat where id_obat = '$ff[jenispelayanan]'";
										$jjj=mysql_fetch_array(mysql_query($dfg));
...
?></td>
	...
	echo $eksekusids['namadokter'];?></td>
	<td align="right"><?php 
	$mm="select sum(bayar) from pelayanan where idantrian='$baris[idantrian]'";

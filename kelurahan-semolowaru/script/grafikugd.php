...
<html>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {			
				...
				options = {
					   ...
					   title: {
					      text: 'Diagram Presentase Pengunjung                                                        '
					   },
					   xAxis: {
					   },
					   yAxis: {
					      title: {
					         text: 'Persentase Pengunjung (%)'
					      }
					   },
					   tooltip: {
					      formatter: function() {
 ...
 <div align="center" id="leftPango1"><span class="title">GRAFIK PENGUNJUNG</span></div>
<br/>
 <div align="center" ><h2>Grafik Pengunjung UGD</h2></div>
        ...
        <tr>
            <th width="30%"><font size="2" color="blue">Tanggal</font></th>
          	<th width="35%"><font size="2" color="blue">Jumlah Pengunjung</font></th>
				...
				<tr>
					...
					$tgl_temp=explode("-",$row['namasetting']); 
						...
						$thn=$tgl_temp[0]; 		
							...
							?></font></div></th>
					<td align="center"><?php 
					$queryw=mysql_fetch_array(mysql_query("select count(idantrian) from antrian where tanggalkunjungan='$row[namasetting]' and poli='Laboratorium'"));
					$tt=$queryw[0];
					$queryw1=mysql_fetch_array(mysql_query("select count(idrujukan) from rujukan where tgl_rujukan='$row[namasetting]' and rujukanke='Laboratorium'"));
					$gg=$queryw1[0];
					echo $jj=$tt+$gg;
					?></font></td>

...
<body>
  ...
  <div id="wrapper">
		...
		<form name="form1" method="post" action="hasilcarikeluar.php">  
			PENCARIAN DATA OBAT KELUAR<br>
			<select name="kolom">
        ...
        <tr align='center'>
		  ...
		  <td width="10%">Jumlah Obat</td>
		  <td width="10%">TGL Keluar</td>
		  <td width="10%">Operasi</td>
		<?
$kolom=$_POST['kolom'];
$cari = $_POST['cari'];
$strSQL = "select * from obat_keluar where $kolom like '%$cari%'";
...
while($baris=mysql_fetch_array($qry))
 ...
 print "<tr align=\"center\"align=\"middle\">
	...
	<td align=center><a href=delkeluar.php?id=".$baris["no"].">Hapus</a> I <a href=editkeluar.php?id=".$baris["no"].">Edit</a></td>
	</tr>";
}
}					  
		?>	

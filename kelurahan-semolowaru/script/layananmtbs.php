...
<script type="text/javascript">
 ...
 <div align="center" id="leftPango1"><span class="title">POLI MTBS</span></div>
 ...
 <table width="80%" border="0" cellpadding="2" cellspacing="2">
			  ...
			  <tbody>
			   ...
			   <tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="20%"><div align="left"><?php echo $row["noktppasien"]; ?></div></td>
			...
			$tgl_temp1=explode("-",$row['tanggallahir']); 
						...
						$thn1=$tgl_temp1[0]; 		
							...
							echo " "; echo $tgl1 ; echo " "; echo $bln1; echo " ";echo $thn1;echo " ";?>
							</div>
					</td>
	...
	<div align="center" id="leftPango1"><span class="title">Form Kunjungan Poli MTBS</span></div>
<div><br/>
	<h2>Form Kunjungan Poli MTBS</h2><br>
		<form id="form1" name="form1" method="post" onSubmit="return validasi(this)" action="script/simpanantrianmtbs.php?norekammedik=<?php echo $row['norekammedik']?>">         
			  ...
			  <tbody>
			    ...
			    <tr>
                 ...
                 <tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"><input name="poli" readonly="true" id="poli" size="25" value="MTBS"/></div>
					</td>
				</tr>

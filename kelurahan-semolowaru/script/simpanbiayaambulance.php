...
$max=mysql_query("select max(idsetting)+1 from setting");
  ...
  $sql="INSERT INTO setting VALUES('$idmax', '$_POST[nama]','$_POST[biaya]', 'Ambulance')";
...
<script>document.location.href="../tatausaha.php?puskesmas=tambahpenggunaanambulance" </script>
<?php
}else{

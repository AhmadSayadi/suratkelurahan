...
<script type="text/javascript">
	...
	<div id="rightcolumn">
 <div align="center" id="leftPango1"><span class="title">POLI RAWAT INAP</span></div>
     <br/> <h2>Data Pasien</h2>
 		 	<?php
			include "koneksi.php";
			$id = $_GET['idpasien'];
...
?></div>
	...
	<div align="center" id="leftPango1"><span class="title">Form Kunjungan Rawat Inap</span></div>
<div><br/>
	<h2>Form Kunjungan Rawat Inap</h2><br>
		<form id="form1" name="form1" onSubmit="return validasi(this)" method="post" action="script/simpanantrianrawatinap.php?norekammedik=<?php echo $row['norekammedik']?>">         
            ...
            <tr>
			  ...
			  <tbody>
                ...
                <tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"><input name="poli" readonly="true" id="poli" size="25" value="Rawat Inap"/></div>
					</td>
				</tr>

...
<body>
 ...
 <div align="center" id="leftPango1"><span class="title">REPORT OBAT MASUK</span></div>
<br/>	<h2>Report Obat Masuk</h2>

	<form method="POST" target="_BLANK" action="script/cetakdatamasuk.php">
<table>

...
<html>
	...
	<body>
 <div align="center" id="leftPango1"><span class="title">GRAFIK PENGUNJUNG LABORATORIUM</span></div>
	<br/><div align="center" ><h2>Grafik Pengunjung Laboratorium</h2></div>
				...
				<tr>
					...
					$tgl_temp=explode("-",$row['namasetting']); 
						...
						$thn=$tgl_temp[0]; 		
							...
							?></font></div></th>
					<td align="center"><?php 
					$queryw=mysql_fetch_array(mysql_query("select count(idrujukan) from rujukan where tgl_rujukan='$row[namasetting]' && rujukanke='Laboratorium'"));
					echo $queryw[0];
					?></font></td>

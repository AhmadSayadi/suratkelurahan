...
<title>DATA PELAYANAN RAWAT INAP</title>
...
div.header{		
	...
	<div class="page">
		...
		<div class="header2">			
			<div>Data Pelayanan Rawat Inap</div>
		</div>
		<div class="content">
		<br><br>
...
echo $str;
 ...
 <table width="100%" border="0" cellpadding="2" cellspacing="2">
	...
	Keterangan Sakit :<br/>
	<p align="justify"><?php 
	$rowqsdd = mysql_fetch_array(mysql_query("SELECT * FROM antrian where idantrian='$_GET[idantrian]'"));
							echo $rowqsdd['keterangan'];
...
<?php
				$minta="select * from pelayanan where idantrian = '$_GET[idantrian]' && poli ='Rawat Inap'";
				$eksekusi =mysql_query($minta);
		
				if(mysql_num_rows($eksekusi) != 0){
				?>
				<br/>
				<h2>Daftar Pelayanan Rawat Inap</h2><br/>
		<table class="data" border="1" cellpadding="0" cellspacing="0">
		<tr align='center'>
		  <th width="3%">No</th>
		  <th width="10%">Tanggal</th>
 ...
 $eksekusids = mysql_fetch_array(mysql_query($mintads));
	...
	$mintad="select * from setting where idsetting = '$baris[keterangan]'";
	$eksekusid=mysql_fetch_array(mysql_query($mintad));
 ...
 print "<tr align=\"center\"align=\"middle\">
	...
	<tr align='center'>
		  ...
		  <th colspan="3" align="right" width="10%">Total</th>
		  <th width="8%"><?php echo $ff;?></th>
		 </tr>
	</table>

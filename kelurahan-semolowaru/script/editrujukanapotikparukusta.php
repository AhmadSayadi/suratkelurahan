...
$row = mysql_fetch_array($result);
	?>
	<center>
 <div align="center" id="leftPango1"><span class="title">EDIT RUJUKAN APOTIK POLI PARU & KUSTA</span></div>
</center>
 <br/>
                  <h2>Edit Rujukan Apotik Poli Paru & Kusta</h2>
	
				<form id="form1" name="form1" method="post" action="script/updaterujukanapotikparukusta.php?idantrian=<?php echo $_GET['idantrian'];?>&idrujukan=<?php echo $_GET['idrujukan']?>">         
...
?>
			  <tr>
				...
				<tr valign="top">
                    <td width="5%"><div align="center">2</div></td>
                    <td width="30%"><div align="left">Obat</div></td>
                    <td width="5%"><div align="center">:</div></td>

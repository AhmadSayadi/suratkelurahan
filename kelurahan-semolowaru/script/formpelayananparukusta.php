...
<body>  <div align="center" id="leftPango1"><span class="title">FORM PELAYANAN PARU & KUSTA</span></div>
<form id="form1" name="form1" method="post" action="script/simpanpelayananparukusta.php?idantrian=<?php echo $_GET['idantrian']?>&norekammedik=<?php echo $row['norekammedik'];?>">         
 <table width="100%" border="0" cellpadding="2" cellspacing="2">

            <tr>
              <td><table align="left" border="0" cellpadding="0" cellspacing="5">
			  <tbody>
			  <tr><td colspan="4"><br/><h2>Form Pelayanan Paru & Kusta</h2></td></tr>
                ...
                <tr valign="top">
				  <td width="5%"><div align="center">1</div></td>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	...
                   	<td width="50%"><div align="left"><textarea name="keterangan" id="keterangan" title="Masukkan Keterangan"  style="width : 330px; height : 100px;" placeholder="Masukkan Keterangan" value="0" type="text" required /></textarea></div></td>
                  
                </tr>
<tr>
                    <td width="5%"><div align="center">2</div></td>
                    <td width="30%"><div align="left">Jenis Pelayanan</div></td>
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left">
					<select name="nip" required>
						<option value="">Pilihlah Jenis Pelayanan</option>

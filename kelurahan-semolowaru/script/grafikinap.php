...
<html>
	...
	<body>
 <div align="center" id="leftPango1"><span class="title">GRAFIK PENGUNJUNG POLI INAP</span></div>
	<br/><div align="center" ><h2>Grafik Pengunjung Poli Inap</h2></div>
				...
				<tr>
					...
					$tgl_temp=explode("-",$row['namasetting']); 
						...
						$thn=$tgl_temp[0]; 		
							...
							?></font></div></th>
					<td align="center"><?php 
					$queryw=mysql_fetch_array(mysql_query("select count(idrujukan) from rujukan where tgl_rujukan='$row[namasetting]' && rujukanke='inap'"));
					$queryw1=mysql_fetch_array(mysql_query("select count(idantrian) from antrian where tanggalkunjungan='$row[namasetting]' && poli='Rawat Inap'"));
					$er=$queryw[0];
					$err=$queryw1[0];
					echo $rrr=$er+$err;
					?></font></td>

            ...
            <tr>
			  ...
			  <tr>
				...
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="id" id="id" size="25" readonly='true' type="text" value="<?=$row["id"] ?>"/></div>
					</td>
				</tr>
			  <tr>
                    <td width="5%"><div align="center">2</div></td>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="tgl_periksa" id="tgl_periksa" readonly='true' size="25" type="text" value="<?=$row["tgl_pemeriksaan"] ?>"/>mis. 2011-10-25</div>
					</td>
				</tr>
                <tr>
				  <td width="5%"><div align="center">3</div></td>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	...
                   	<td width="50%"><div align="left"><input name="nama" id="nama" readonly='true' size="25" type="text" value="<?=$row["nama"] ?>"/></div></td>
				...
				<tr valign="top">
                    ...
                    <td><div align="left"><input name="umur" size="25" type="text" readonly='true' id="umur" value="<?=$row["umur"] ?>" /></div></div>
                    </td>
				  </tr>
				<tr valign="top">
                    ...
                    <td><div align="center">:</div></td>
                    <td><div align="left"><input name="nama_kk" size="25" type="text" readonly='true' id="nama_kk" value="<?=$row["nama_kk"] ?>" /></div></div>
                    </td>
				  </tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="alamat" id="alamat" readonly='true' size="25" value="<?=$row["alamat"] ?>"/></div>
					</td>
				</tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="bsn" id="bsn" size="25" readonly='true' type="text" value="<?=$row["bsn"] ?>"/></div>
					</td>
				</tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="jpp" id="jpp" size="25" readonly='true' type="text" value="<?=$row["jpp"] ?>"/></div>
					</td>
				</tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="gda" id="gda" size="25" readonly='true' type="text" value="<?=$row["gda"] ?>"/></div>
					</td>
				</tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="chol" id="chol" size="25" readonly='true' type="text" value="<?=$row["chol"] ?>"/></div>
					</td>
				</tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="ua" id="ua" size="25" readonly='true' type="text" value="<?=$row["ua"] ?>"/></div>
					</td>
				</tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="sgot" id="sgot" size="25" readonly='true' type="text" value="<?=$row["sgot"] ?>"/></div>
					</td>
				</tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="sgpt" id="sgpt" size="25" readonly='true' type="text" value="<?=$row["sgpt"] ?>"/></div>
					</td>
				</tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="bun" id="bun" size="25" readonly='true' type="text" value="<?=$row["bun"] ?>"/></div>
					</td>
				</tr>
				<tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="50%"><div align="left"><input name="creat" id="creat" readonly='true' size="25" type="text" value="<?=$row["creat"] ?>"/></div>
					</td>
				</tr>
				<tr>
...
<a href="kimia.php"><img src="../image/undo.png" width="100"></a>
		 </div>

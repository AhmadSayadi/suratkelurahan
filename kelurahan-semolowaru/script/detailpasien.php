...
<?php
	...
	<td colspan="6" align="center">
				...
				<input type="reset" value="Cancel" /> </td>
                  	 ...
                  	 <a onClick="return confirm('Apakah Anda Yakin Untuk Menghapus Pasien Ini ?')" href="script/delpasien.php?idpasien=<?php echo $row['idpasien']; ?>"><img src="images/delete.png" width="50"></a>
		 </div>
</body>
</html>
<?

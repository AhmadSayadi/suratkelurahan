...
$row = mysql_fetch_array($result);
	?>
	<center>
 <div align="center" id="leftPango1"><span class="title">EDIT RUJUKAN AMBULAN GIZI</span></div>
</center>
 <br/>
                  <h2>Edit Rujukan Ambulan Gizi</h2>
	
				<form id="form1" name="form1" method="post" action="script/updaterujukanambulangizi.php?idantrian=<?php echo $_GET['idantrian'];?>&idrujukan=<?php echo $_GET['idrujukan']?>">         

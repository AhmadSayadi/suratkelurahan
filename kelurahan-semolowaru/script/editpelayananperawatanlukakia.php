...
$row = mysql_fetch_array($result);
	?>
	<center>
 <div align="center" id="leftPango1"><span class="title">EDIT PELAYANAN PERAWATAN LUKA</span></div>
</center>
 <br/>
                  <h2>Edit Pelayanan Perawatan Luka</h2>
	
				<form id="form1" name="form1" method="post" action="script/updatepelayananperawatanlukakia.php?idpelayanan=<?php echo $_GET['idpelayanan'];?>&idantrian=<?php echo $row['idantrian']?>">         

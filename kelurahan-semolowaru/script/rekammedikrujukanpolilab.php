...
<title>Data Pelayanan Laboratorium</title>
...
div.header{		
	...
	<div class="page">
		...
		<div class="header2">			
			<div>Data Pelayanan Laboratorium</div>
		</div>
		<div class="content">
		<br><br>
...
$rowl = mysql_fetch_array($resultl);
	...
	<p align="justify"><?php echo $rowl['keterangan']?></p></td>
				...
				?>
				<br/>
				<h2>Daftar Pelayanan Laboratorium</h2><br/>
		<table class="data" border="1" cellpadding="0" cellspacing="0">
		<tr align='center'>
		  <th width="3%">No</th>
		  <th width="10%">Tanggal</th>
		  <th width="10%">Tes Lab</th>
		  <th width="10%">Keterangan</th>
		  <th width="8%">Bayar</th>
		 </tr>
		<?
		            
			$minta="select * from pelayanan where idantrian = '$_GET[idantrian]' && poli ='Laboratorium'";
				$eksekusi =mysql_query($minta);
		$no=0;
 ...
 print "<tr align=\"center\"align=\"middle\">
	...
	<td>$baris[bayar]</td>
		...
		?>
				...
				<table class="data" border="1" cellpadding="0" cellspacing="0">
				<?
				$jum="SELECT SUM(bayar) as jum FROM pelayanan where idantrian = '$_GET[idantrian]' && poli ='Laboratorium'";
				$eks = mysql_query($jum);

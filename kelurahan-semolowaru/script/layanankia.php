...
<script type="text/javascript">
 ...
 <div align="center" id="leftPango1"><span class="title">POLI IBU DAN ANAK</span></div>
...
?></div>
                ...
                <tr>
				 ...
				 <td width="20%"><div align="left">Tanggal Lahir</div></td>
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="20%"><div align="left"><?php echo $row["tanggallahir"] ?></div>
					</td>
	...
	<div align="center" id="leftPango1"><span class="title">Form Kunjungan Poli Ibu dan Anak</span></div>
<br/><div>
	<h2>Form Kunjungan Poli Ibu dan Anak</h2><br>
		<form id="form1" name="form1" method="post" onSubmit="return validasi(this)" action="script/simpanantriankia.php?norekammedik=<?php echo $row['norekammedik']?>">         
			  ...
			  <tbody>
			    ...
			    <tr>
                 ...
                 <tr>
                    ...
                    <td width="5%"><div align="center">:</div></td>
                   	<td width="30%"><div align="left"><input name="poli" readonly="true" id="poli" size="25" value="Kia"/></div>
					</td>
				</tr>

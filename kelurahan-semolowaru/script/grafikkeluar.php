...
<html>
	...
	<body>
 <div align="center" id="leftPango1"><span class="title">GRAFIK OBAT KELUAR</span></div>
	<br/><div align="center" ><h2>Grafik Obat Keluar</h2></div>
		...
		<tbody>
			...
			while($row=mysql_fetch_array($query)){
				...
				<tr>
					...
					<td align="center"><?php 
					include "koneksi.php";
					$queryw=mysql_fetch_array(mysql_query("select sum(jumlah_keluar) from obat_keluar where tgl_keluar='$row[namasetting]'"));
					echo $queryw[0]*1;
					?></font></td>
